...
class CommitteeCurationScreen extends StatefulWidget {
  const CommitteeCurationScreen({super.key});

  @override
  State<CommitteeCurationScreen> createState() => _CommitteeCurationScreenState();
}

class _CommitteeCurationScreenState extends State<CommitteeCurationScreen> {
