...
class TeacherDraftingScreen extends StatefulWidget {
  const TeacherDraftingScreen({super.key});

  @override
  State<TeacherDraftingScreen> createState() => _TeacherDraftingScreenState();
}

class _TeacherDraftingScreenState extends State<TeacherDraftingScreen> {
  ...
  Future<void> _recallQuestion(String questionId) async {
    setState(() => _isLoading = true);
    try {
      await _questionService.recallToDraft(questionId);
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Enter the body of the question here...',
                ),
              ...
              const Text(
                'Associated learning topic(s):',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13),
              ),
              const SizedBox(height: 8),
              if (_courseTopics.isEmpty)
                const Text('No topics defined for this course yet.', style: TextStyle(color: Colors.grey, fontSize: 12))
              else
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (val) =>
                                val == null || val.trim().isEmpty ? 'Option text is required.' : null,
                          ),
                        ),
                      ],
                    ),
                  ...
                  children: [
                    if (_optionControllers.length < 5)
                      TextButton.icon(
                        ...
                        label: const Text('Add Option (Max 5)'),
                      ),
                    if (_optionControllers.length > 4) ...[
                      ...
                      TextButton.icon(
                        ...
                        label: const Text('Remove Last Option', style: TextStyle(color: Colors.redAccent)),
                      ),
                    ],
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Submit to Committee'),
                    ),
                  ],
                ),
              ],
